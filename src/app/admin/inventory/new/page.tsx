    ...
    <div className="max-w-2xl mx-auto">
       ...
       >
          <div className="mb-8">
             ...
             <p className="text-muted-foreground">Add a new item to the prison store.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
             ...
             <div className="pt-4">
                ...
                >
                    {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : <><Save className="w-5 h-5" /> Add Product</>}
                </button>
             </div>
          </form>
       </MotionDiv>
