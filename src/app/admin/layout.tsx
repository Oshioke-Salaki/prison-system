...
import { Shield, Users, FileText, Box, Settings, LogOut, LayoutDashboard, Grid } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { icon: Users, label: 'Inmates', href: '/admin/inmates' },
    { icon: Grid, label: 'Cells', href: '/admin/cells' },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      <aside className="w-64 border-r border-white/10 bg-card/50 backdrop-blur-xl flex flex-col fixed h-full z-20">
        <div className="h-16 flex items-center gap-3 px-6 border-b border-white/10">
          ...
          <span className="font-bold text-lg tracking-tight">Sentinell<span className="text-primary text-xs ml-1">ADMIN</span></span>
        </div>
